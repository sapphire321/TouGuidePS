...
public class AsianFoodFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        place.add(new Restaurant(getString(R.string.Header_LAO), getString(R.string.Description_LAO), R.drawable.asian_food));
        ...
        // in the list.
        RestaurantAdapter adapter = new RestaurantAdapter(getActivity(), place, R.color.foodAsian);
